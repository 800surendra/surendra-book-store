...
from .models import Address, Order, OrderItem, PaymentProof
import json
...
def payment_screen(request):
    ...
    valid_methods = set(dict(Order.PAYMENT_METHODS).keys())
