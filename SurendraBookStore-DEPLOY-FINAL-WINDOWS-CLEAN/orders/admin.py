...
import re
from .models import Order, OrderItem, PaymentProof, Address, OrderEvent
from commerce.services import grant_verified_ebook_access
...
def verify_payment_action(
    ...
    for order in queryset:
        ...
        grant_verified_ebook_access(order)
...
class OrderEventInline(admin.TabularInline):
    ...
    extra = 0
    can_delete = False
    readonly_fields = ("actor", "event_type", "previous_status", "new_status", "note", "created_at")
...
class OrderEventAdmin(admin.ModelAdmin):
    list_display = ("order", "event_type", "actor", "previous_status", "new_status", "created_at")
    list_filter = ("event_type", "new_status")
    search_fields = ("order__id", "order__email", "note")
    readonly_fields = ("order", "actor", "event_type", "previous_status", "new_status", "note", "created_at")
