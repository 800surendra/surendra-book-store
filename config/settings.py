...
SECRET_KEY = 'django-insecure-@ultrapro@max@2026@harish@bookstore'
...
ROOT_URLCONF = 'config.urls'  # Agar aapka urls.py config mein hai toh
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'cart.context_processors.cart_total',   # <--- YEH SAHI NAAM HAI
            ],
        },
    },
]
